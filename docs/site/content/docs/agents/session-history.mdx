...
- [Fork an agent session](/docs/terminal#fork-an-agent-session) — copy a live conversation into a new worktree under a new session id, instead of resuming this one in place.
